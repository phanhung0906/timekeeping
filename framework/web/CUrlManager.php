 ...
 * <ul>
 * <li>The first rule says that if the admin requests the URL '/path/to/days.php/articles',
 *   it should be treated as '/path/to/days.php/article/list'; and vice versa applies
 *   when constructing such a URL.</li>
 * <li>The second rule contains a named parameter 'id' which is specified using
 *   the &lt;ParamName:RegExp&gt; syntax. It says that if the admin requests the URL
 *   '/path/to/days.php/article/13', it should be treated as '/path/to/days.php/article/read?id=13';
 ...
 * For example, using the rules above, the URL '/days.php/post/123/create'
 ...
 * <code>admin=admin</code> and <code>lang=en</code>. On the other hand, rules with hostname may also be used to
 * create URLs with parameterized hostnames.
 *
 * In order to use parameterized hostnames, simply declare URL rules with host info, e.g.:
 * <pre>
 * array(
 *     'http://<admin:\w+>.example.com/<lang:\w+>/profile' => 'admin/profile',
 * )
 * </pre>
 *
