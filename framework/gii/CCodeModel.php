 ...
 * The purpose of a code model is to represent admin-supplied parameters and use them to
 * generate customized code.
 *
 * Derived classes should implement the {@link prepare} method whose main task is to
 * fill up the {@link files} property based on the admin parameters.
 *
 ...
 * that can remember its last valid value, even if the admin closes his browser window
...
abstract class CCodeModel extends CFormModel
{
	...
	/**
	 * @var array admin confirmations on whether to overwrite existing code files with the newly generated ones.
