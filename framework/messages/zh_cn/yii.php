...
return array (
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache用户缓存北京永。请在php.ini中设置wincache.ucenabled启用。',
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => '授权项目 "{item}" 已经被指派给使用者 "{admin}".',
