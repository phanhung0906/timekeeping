...
return array (
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache потребителския кеш е изключен. Моля, задайте wincache.ucenabled на On във вашия php.ini.',
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Елемента за оторизация "{item}", вече е назначен към потребителя "{admin}".',
