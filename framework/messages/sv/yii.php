...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Användaren "{admin}" har redan tilldelats auktoriseringsobjektet "{item}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache användarcache är avaktiverad. Var god sätt wincache.ucenabled till On i php.ini.',
