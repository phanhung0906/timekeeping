...
<div class='alert alert-success animate-in' style='display: none' data-anim-type="flip-in-top-front" data-anim-delay="500">
    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
    <strong><?php echo Yii::t('app','Success') ?>!</strong> <?php echo Yii::t('app','Account have been remove') ?>
</div>
<div class='alert alert-danger animate-in' style='display: none' data-anim-type="flip-in-top-front" data-anim-delay="500">
    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
    <strong><?php echo Yii::t('app','Error') ?>!</strong> <?php echo Yii::t('app',"Account haven't been remove") ?>
</div>
<!--<form class="form-inline pull-right" role="search" method="post" id='searchForm'>-->
...
<!--</form>-->
<h1 class='animate-in' data-anim-type="bounce-in-right-large" data-anim-delay="1000">
    <a href="http://<?php echo ROOT_URL ?>/admin/add" class='btn btn-primary'><span class="fa fa-user"></span> <?php echo Yii::t('app','Add new user') ?></a>
</h1>

<div class="panel panel-default animate-in" data-anim-type="bounce-in-left-large" data-anim-delay="1000">
    ...
    <table class='table table-hover' id='adminIndex'>
        ...
        <?php for($i = 0; $i < count($user); $i++): ?>
            <tr>
                ...
                <td class='text-center'>
                    <div class="btn-group">
                        <a href="http://<?php echo ROOT_URL ?>/admin/edit/id/<?php echo $user[$i]['user_id'] ?>" class='btn btn-info' data-toggle="tooltip" title="<?php echo Yii::t('app','Edit') ?>"><i class="fa fa-wrench"></i> </a>
                        <button class='btn btn-danger deleteUser' data-id='<?php echo $user[$i]['user_id'] ?>' data-toggle="modal" data-target="#modalDeleteUser" data-toggle="tooltip" title="<?php echo Yii::t('app','Delete') ?>"><i class="fa fa-trash-o"></i></button>
                    </div>
                </td>
            </tr>
        <?php endfor; ?>
