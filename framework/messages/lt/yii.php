...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Autorizacijos elementas „{item}“ jau yra priskirtas naudotojui „{admin}“.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache naudotojo podėlis yra išjungtas. Norėdami įjungti, php.ini faile wincache.ucenabled reikšmę nustatykite On.',
