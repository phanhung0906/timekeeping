 ...
 *         )),
 *         array('label'=>'Login', 'url'=>array('site/login'), 'visible'=>Yii::app()->admin->isGuest),
 *     ),
 * ));
 * </pre>
 *
...
class CMenu extends CWidget
{
	 ...
	 * This can be used to control the visibility of menu items based on admin permissions.</li>
