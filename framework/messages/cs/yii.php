...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Autorizační záznam "{item}" je už přiřazený uživateli "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache je deaktivovaná. Nastavte prosím wincache.ucenabled "On" v konfiguračním souboru php.ini.',
