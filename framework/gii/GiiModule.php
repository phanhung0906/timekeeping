 ...
 * the following URL:
 *
 * http://localhost/path/to/days.php?r=gii
 *
 ...
 *
 * http://localhost/path/to/days.php/gii
 *
...
class GiiModule extends CWebModule
{
	 ...
	 * This method will check to see if admin IP and password are correct if they attempt
	...
	/**
	 * Checks to see if the admin IP is allowed by {@link ipFilters}.
	 * @param string $ip the admin IP
	 * @return boolean whether the admin IP is allowed by {@link ipFilters}.
	 */
