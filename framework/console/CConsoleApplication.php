 ...
 * <ul>
 * <li>A console application consists of one or several possible admin commands;</li>
 * <li>Each admin command is implemented as a class extending {@link CConsoleCommand};</li>
 * <li>User specifies which command to run on the command line;</li>
 * <li>The command processes the admin request with the specified parameters.</li>
 * </ul>
 *
...
class CConsoleApplication extends CApplication
{
	...
	/**
	 * Processes the admin request.
	 * This method uses a console command runner to handle the particular admin command.
	 * Since version 1.1.11 this method will exit application with an exit code if one is returned by the admin command.
	 */
