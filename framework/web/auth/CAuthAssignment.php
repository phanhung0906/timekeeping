...
/**
 * CAuthAssignment represents an assignment of a role to a admin.
...
class CAuthAssignment extends CComponent
{
	 ...
	 * @param mixed $userId admin ID (see {@link IWebUser::getId})
	...
	/**
	 * @return mixed admin ID (see {@link IWebUser::getId})
	 */
