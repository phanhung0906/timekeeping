...
<p>
    If you think you are ready, please <?php echo CHtml::link('click here to start the installation process', Yii::app()->controller->createUrl( '/meeting/install/step', array( 'n' => 1 ) )) ; ?>.
</p>
