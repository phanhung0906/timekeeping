...
return array (
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'La caché d\'usuari CWinCache esta desactivada. Si us plau, canvï wincache.ucenabled a ON al seu php.ini.',
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'L\'element d\'autorització "{item}" ha set assignat a l\'usuari "{admin}".',
