...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Authorisatie-item "{item}" was al aan gebruiker "{admin}" toegewezen.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'De CWinCache gebruikerscache staat af. Gelieve wincache.ucenabled op "On" te zetten in php.ini.',
