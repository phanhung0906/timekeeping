...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Το αντικείμενο πιστοποίησης "{item}" έχει οριστεί στο χρήστη "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Η λανθάνουσα μνήμη χρήστη CWinCache είναι απενεργοποιημένη. Ορίστε το wincache.ucenabled στην τιμή On στο php.ini.',
