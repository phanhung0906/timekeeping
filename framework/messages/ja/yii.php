...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => '認証項目 "{item}" は既にユーザ "{admin}" に割り当てられています。',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCacheユーザキャッシュが無効化されています。php.ini中のwincache.ucenabledをOnに設定してください。',
