 ...
 */
class MeetingModule extends CWebModule
{
    /**
     * admin  
     * 
	...
	public function beforeControllerAction($controller, $action)
	{
		if(parent::beforeControllerAction($controller, $action))
		{
            ...
            require_once( YiiBase::getPathOfAlias( 'application.modules.meeting.components') . '/dbconfig.php' );
        ...
        if ($this->_assetsUrl === null)
        {
            $this->_assetsUrl = Yii::app()->
                getAssetManager()
                    ->publish( 
                        Yii::getPathOfAlias(
                            'application.modules.meeting.assets'
                        ),
                        false,
                        -1,
                        YII_DEBUG
