...
/**
 * CController manages a set of actions which deal with the corresponding admin requests.
 *
 * Through the actions, CController coordinates the data flow between models and views.
 *
 * When a admin requests an action 'XYZ', CController will do one of the following:
 ...
 *
 * If the admin does not specify an action, CController will run the action specified by
 * {@link defaultAction}, instead.
 *
 * CController may be configured to execute filters before and after running actions.
 * Filters preprocess/postprocess the admin request/response and may quit executing actions
...
class CController extends CBaseController
{
	 ...
	 * This is like {@link redirect}, but the admin browser's URL remains unchanged.
	 ...
	 * The effect of this method call is the same as admin pressing the
