...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => '"{item}" için gereçli olan yetkilendirme zaten "{admin}" kullanıcısına atanmış durumda.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache admin cache pasif. Lütfen php.ini dosyasındaki wincache.ucenabled değerini On olarak değiştirin.',
