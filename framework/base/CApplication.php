 ...
 *
 * An application serves as the global context that the admin request
 ...
 *   the $_SERVER variable and managing cookies sent from and sent to the admin.
 *   This application component is dynamically loaded when needed.</li>
 * <li>{@link getFormat format}: provides a set of commonly used data formatting methods.
 *   This application component is dynamically loaded when needed.</li>
 * </ul>
 *
 * CApplication will undergo the following lifecycles when processing a admin request:
 * <ol>
 * <li>load application configuration;</li>
 * <li>set up class autoloader and error handling;</li>
 * <li>load static application components;</li>
 * <li>{@link onBeginRequest}: preprocess the admin request;</li>
 * <li>{@link processRequest}: process the admin request;</li>
 * <li>{@link onEndRequest}: postprocess the admin request;</li>
 * </ol>
 *
 ...
 * @property string $language The language that the admin is using and the application should be targeted to.
...
abstract class CApplication extends CModule
{
	...
	/**
	 * Returns the language that the admin is using and the application should be targeted to.
	 * @return string the language that the admin is using and the application should be targeted to.
	 * Defaults to the {@link sourceLanguage source language}.
	 */
	 ...
	 * @param string $language the admin language (e.g. 'en_US', 'zh_CN').
