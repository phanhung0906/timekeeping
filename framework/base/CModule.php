 ...
 * @property CAttributeCollection $params The list of admin-defined parameters.
...
abstract class CModule extends CComponent
{
	...
	/**
	 * Returns admin-defined parameters.
	 * @return CAttributeCollection the list of admin-defined parameters
	 */
	...
	/**
	 * Sets admin-defined parameters.
	 * @param array $value admin-defined parameters. This should be in name-value pairs.
	 */
