...
return array (
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Le cache utilisateur CWinCache est désactivé. Veuillez définir la propriété du fichier php.ini wincache.ucenabled à On.',
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'L\'élément d\'autorisation « {item} » a déjà été assigné à l\'utilisateur « {admin} ».',
