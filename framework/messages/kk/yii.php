...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => '"{item}" авторизация элементі "{admin}" пайдаланушысына бекітілген.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Пайдаланушы CWinCache сөндірулі тұр. Өзіңіздің php.ini ішіндегі wincache.ucenabled мәнін On етіп өзгертіңіз.',
