 ...
 * A admin may be assigned one or several authorization items (called {@link CAuthAssignment assignments}.
...
class CAuthItem extends CComponent
{
	...
	/**
	 * Returns a value indicating whether this item has been assigned to the admin.
	 * @param mixed $userId the admin ID (see {@link IWebUser::getId})
	 ...
	 * this item is not assigned to the admin.
