...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Autorisierungs-Element "{item}" wurde bereits dem Benutzer "{admin}" zugewiesen.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Anwendercache für CWinCache ist deaktiviert. Bitte setzen Sie in Ihrer php.ini wincache.ucenabled auf On.',
