...
class DefaultController extends Controller
{
    ...
    {
        require_once( YiiBase::getPathOfAlias( 'application.modules.meeting.components') . '/datafeed.php' );
        die();
    }
    ...
    public function actionEdit()
    {
        ...
        require_once( YiiBase::getPathOfAlias( 'application.modules.meeting.components') . '/edit.php' );
        die();
    }
    ...
    <script src="src/Plugins/jquery.colorselect.js" type="text/javascript"></script>    */
        ...
        $cs->registerScript( 'absolute_datafeed_url', 'var absolute_datafeed_url="' . Yii::app()->controller->createAbsoluteUrl( '/meeting/default/datafeed' ) . '";', CClientScript::POS_HEAD );
        $cs->registerScript( 'absolute_edit_url', 'var absolute_edit_url="' . Yii::app()->controller->createUrl( '/meeting/default/edit' ) . '";', CClientScript::POS_HEAD );
        $cs->registerScript( 'absolute_default_url', 'var absolute_default_url="' . Yii::app()->controller->createUrl( '/meeting/default/' ) . '";', CClientScript::POS_HEAD );
    ...
    public function actionLstsendmail(){
        $model = new MailModel();
        $lst = $model->lstsendmail();
        $this->render('lstsendmail', array('lst'=>$lst));
    }
}
