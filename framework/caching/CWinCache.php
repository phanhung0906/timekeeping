...
class CWinCache extends CCache {
	 ...
	 * It checks the availability of WinCache extension and WinCache admin cache.
	 * @throws CException if WinCache extension is not loaded or admin cache is disabled
	 */
	public function init()
	{
		...
		if(!ini_get('wincache.ucenabled'))
			throw new CException(Yii::t('yii', 'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.'));
	}
