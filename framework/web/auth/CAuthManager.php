 ...
 * that may be assigned to individual users. A admin is said to have a permission
 ...
 * at appropriate places in the application code to check if the current admin
...
abstract class CAuthManager extends CApplicationComponent implements IAuthManager
{
	 ...
	 * These roles do not need to be explicitly assigned to any admin.
	 ...
	 * it with a biz rule which checks if the current admin is authenticated.
	 ...
	 * @param mixed $userId the admin ID. If not null, only the roles directly assigned to the admin
	 ...
	 * Returns tasks.
	 * This is a shortcut method to {@link IAuthManager::getAuthItems}.
	 * @param mixed $userId the admin ID. If not null, only the tasks directly assigned to the admin
	 ...
	 * Returns operations.
	 * This is a shortcut method to {@link IAuthManager::getAuthItems}.
	 * @param mixed $userId the admin ID. If not null, only the operations directly assigned to the admin
