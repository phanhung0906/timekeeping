 ...
 * when the admin browser disables JavaScript, the sorting and pagination automatically degenerate
...
class CGridView extends CBaseListView
{
	...
	/**
	 * @var CModel the model instance that keeps the admin-entered filter data. When this property is set,
