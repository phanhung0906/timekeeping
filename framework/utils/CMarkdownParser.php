...
class CMarkdownParser extends MarkdownExtra_Parser
{
	...
	/**
	 * Returns the admin-entered highlighting options.
	 * @param string $codeblock code block with highlighting options.
	 * @return string the admin-entered highlighting options. Null if no option is entered.
	 */
	 ...
	 * @param string $options the admin-entered options
	 ...
	 * @param string $options admin-entered options
	 ...
	 * @param string $str the admin-entered options
