...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Authorization item "{item}" đã được gán cho admin "{admin}" rồi.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache admin cache bị tắt. Xin thiết lập wincache.ucenabled là On trong php.ini của bạn.',
