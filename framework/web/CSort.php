...
class CSort extends CComponent
{
	 ...
	 *
	 * In the simple case, a key-value pair can be like <code>'admin'=>'user_id'</code>
	 * where 'admin' is the name of the virtual attribute while 'user_id' means the virtual
	 ...
	 * )
	 * </pre>
	 * where 'admin' is the name of the virtual attribute that specifies the full name of admin
	 * (a compound attribute consisting of first name and last name of admin). In this case,
	 ...
	 * order upon admin clicking the corresponding sort hyperlink if it is not currently sorted. The valid
	 ...
	 * </ul>
	 * @param string $attribute the attribute name that the admin requests to sort on
