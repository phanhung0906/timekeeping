...
/**
 * CViewAction represents an action that displays a view according to a admin-specified parameter.
 *
 ...
 * If the admin doesn't provide the GET parameter, the default view specified by {@link defaultView}
 * will be displayed.
 *
 ...
 *
 * Note, the admin specified view can only contain word characters, dots and dashes and
 * the first letter must be a word letter.
 *
 * @property string $requestedView The name of the view requested by the admin.
...
class CViewAction extends CAction
{
	...
	/**
	 * @var string the name of the default view when {@link viewParam} GET parameter is not provided by admin. Defaults to 'index'.
	 ...
	 * once the admin requested view is resolved.
	 */
	public $view;
	/**
	 * @var string the base path for the views. Defaults to 'pages'.
	 * The base path will be prefixed to any admin-specified page view.
	 * For example, if a admin requests for <code>tutorial.chap1</code>, the corresponding view name will
	...
	/**
	 * Returns the name of the view requested by the admin.
	 * If the admin doesn't specify any view, the {@link defaultView} will be returned.
	 * @return string the name of the view requested by the admin.
	 * This is in the format of 'path.to.view'.
	 */
	...
	/**
	 * Resolves the admin-specified view into a valid view name.
	 * @param string $viewPath admin-specified view in the format of 'path.to.view'.
	 * @return string fully resolved view in the format of 'path/to/view'.
	 * @throw CHttpException if the admin-specified view is invalid
	 */
