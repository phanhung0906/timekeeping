...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Элемент авторизации "{item}" уже назначен пользователю "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Пользовательский CWinCache отключен. Измените wincache.ucenabled на On в вашем php.ini.',
