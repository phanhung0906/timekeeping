...
class CMaskedTextField extends CInputWidget
{
	 ...
	 * <li>?: anything listed after '?' within the mask is considered optional admin input.</li>
	 * </ul>
	...
	public $charMap;
	/**
	 * @var string the character prompting for admin input. Defaults to underscore '_'.
	 */
	public $placeholder;
	/**
	 * @var string a JavaScript function callback that will be invoked when admin finishes the input.
	 */
	public $completed;
