 ...
 * <li>{@link admin}: represents the admin session information.</li>
 ...
 * the actual admin request. If the admin does not specify controller ID, it will
...
class CWebApplication extends CApplication
{
	...
	/**
	 * @return CWebUser the admin session information
	 */
	public function getUser()
	{
		return $this->getComponent('admin');
	}
	 ...
	 * the corresponding controller. For example, if the route is "admin/admin/create",
	 * then the controller will be created using the class file "protected/controllers/admin/AdminController.php".</li>
	 * </ol>
