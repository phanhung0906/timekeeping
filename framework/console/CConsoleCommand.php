 ...
 * when a admin does not specify the action name in his command.
 *
...
abstract class CConsoleCommand extends CComponent
{
	 ...
	 *
	 * @param string $message to echo out before waiting for admin input
	 * @param string $default the default string to be returned when admin does not write anything.
