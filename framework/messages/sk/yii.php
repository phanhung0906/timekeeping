...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Autorizačný záznam "{item}" je už priradený užívateľovi "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache je deaktivovaná. Nastavte prosím wincache.ucenabled "On" v konfiguračnom súbore php.ini.',
