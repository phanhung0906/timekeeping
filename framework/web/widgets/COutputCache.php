 ...
 * any subsequent display of the form should not be cached because it contains admin input.
 ...
 *   should be varied with the admin session.</li>
 ...
 *   should by varied with the admin's language. Available since 1.1.14.</li>
 * </ul>
...
class COutputCache extends CFilterWidget
{
	...
	/**
	 * @var boolean whether the content being cached should be differentiated according to admin sessions. Defaults to false.
	 */
	...
	/**
	 * @var boolean whether the content being cached should be differentiated according to admin's language.
