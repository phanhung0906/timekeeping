...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Item de autorização "{item}" já está assinado para o usuário "{admin}".',
  ...
  'CSecurityManager requires PHP mcrypt extension to be loaded in order to use data encryption feature.' => 'CSecurityManager requer a extensão PHP mcrypt para ser carregado em ordem para admin propriedades de criptografia de dados.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'O cache de usuário do CWinCache está desabilitado. Por favor, configure wincache.ucenabled com o valor On em seu php.ini.',
