    ...
    <div class='d-wrapper'>
        ...
        <div class="d-main" style="padding-top: 70px;">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><b><?php echo Yii::t('app','Meeting room'); ?></b></li>
                <?php if( Yii::app()->session['role'] == 'admin'): ?>
                <li style="float:right;  font-weight:bold;"><a style="color:red;" href="http://<?php echo ROOT_URL ?>/index.php/meeting/default/lstsendmail" data-url='/meeting'><i ></i><?php echo Yii::t('app','List Send Mail') ?></a></li>
                <?php endif; ?>
            </ol>
                    ...
                    <body>
                        <div>
                          ...
                          <div id="calhead" style="padding-left:1px;padding-right:1px;">
                                ...
                                <div id="loadingpannel" class="ptogtitle loadicon" style="display: none;"><?php echo Yii::t('app','Loading data...') ?></div>
                                ...
                                <div id="caltoolbar" class="ctoolbar">
                                  <div id="faddbtn" class="fbutton">
                                    <?php if( ! array_key_exists( 'readonly', $this->module->wd_options ) || $this->module->wd_options[ 'readonly' ] != 'JS:true' ) : // TODO make this prettier ?>
                                        <div>
                                            <span title='Click to Create New Event' class="addcal"><?php echo Yii::t('app','New Event') ?> </span>
                                        </div>
                                    <?php endif; ?>
                                </div>
