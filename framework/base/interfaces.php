...
/**
 * IUserIdentity interface is implemented by a admin identity class.
 *
 * An identity represents a way to authenticate a admin and retrieve
 * information needed to uniquely identity the admin. It is normally
 * used with the {@link CWebApplication::admin admin application component}.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.base
 * @since 1.0
...
interface IUserIdentity
{
	 ...
	 * The information needed to authenticate the admin
	...
	/**
	 * Returns the additional identity information that needs to be persistent during the admin session.
	 * @return array additional identity information that needs to be persistent during the admin session (excluding {@link id}).
	 */
...
/**
 * IWebUser interface is implemented by a {@link CWebApplication::admin admin application component}.
 *
 * A admin application component represents the identity information
...
interface IWebUser
{
	 ...
	 * @return boolean whether the admin is a guest (not authenticated)
	 */
...
interface IAuthManager
{
	 ...
	 * @param mixed $userId the admin ID. This should be either an integer or a string representing
	 * the unique identifier of a admin. See {@link IWebUser::getId}.
	...
	/**
	 * Returns the authorization items of the specific type and admin.
	 * @param integer $type the item type (0: operation, 1: task, 2: role). Defaults to null,
	 * meaning returning all items regardless of their type.
	 * @param mixed $userId the admin ID. Defaults to null, meaning returning all items even if
	 * they are not assigned to a admin.
	...
	/**
	 * Assigns an authorization item to a admin.
	 * @param string $itemName the item name
	 * @param mixed $userId the admin ID (see {@link IWebUser::getId})
	 * @param string $bizRule the business rule to be executed when {@link checkAccess} is called
	 * for this particular authorization item.
	 * @param mixed $data additional data associated with this assignment
	 * @return CAuthAssignment the authorization assignment information.
	 * @throws CException if the item does not exist or if the item has already been assigned to the admin
	 */
	public function assign($itemName,$userId,$bizRule=null,$data=null);
	/**
	 * Revokes an authorization assignment from a admin.
	 * @param string $itemName the item name
	 * @param mixed $userId the admin ID (see {@link IWebUser::getId})
	...
	/**
	 * Returns a value indicating whether the item has been assigned to the admin.
	 * @param string $itemName the item name
	 * @param mixed $userId the admin ID (see {@link IWebUser::getId})
	 * @return boolean whether the item has been assigned to the admin.
	 */
	 ...
	 * the item is not assigned to the admin.
	 */
	public function getAuthAssignment($itemName,$userId);
	/**
	 * Returns the item assignments for the specified admin.
	 * @param mixed $userId the admin ID (see {@link IWebUser::getId})
	 * @return array the item assignment information for the admin. An empty array will be
	 * returned if there is no item assigned to the admin.
	 */
