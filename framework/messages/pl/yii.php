...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Żeton "{item}" został już przypisany użytkownikowi "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Bufor użytkownika CWinCache jest wyłączony. Ustaw wincache.ucenabled na wartość On w Twoim pliku php.ini.',
