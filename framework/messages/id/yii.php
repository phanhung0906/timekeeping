...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Item otorisasi "{item}" sudah ditempatkan kepada pengguna "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache admin cache dinonaktifkan. Harap set wincache.ucenabled menjadi On pada php.ini anda.',
