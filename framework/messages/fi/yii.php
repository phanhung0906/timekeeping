...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Auktorisointiosio "{item}" on jo osoitettu käyttäjälle "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache admin cache on pois käytöstä. Aseta php.ini-tiedostoon wincache.ucenabled-arvoksi "On".',
