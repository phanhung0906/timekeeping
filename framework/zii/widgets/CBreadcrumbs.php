 ...
 *
 * For example, breadcrumbs like "Home > Sample Post > Edit" means the admin is viewing an edit page
...
class CBreadcrumbs extends CWidget
{
	 ...
	 * "Sample post" points to the "days.php?r=post/view&id=12" page, and "Edit" is a label. Note that the "Home" link
