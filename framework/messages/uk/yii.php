...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'Елемент авторизації "{item}" вже призначений користувачу "{admin}".',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Користувальницький CWinCache відключено. Змініть wincache.ucenabled на On у вашому php.ini.',
