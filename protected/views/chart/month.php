...
<ul class="nav nav-tabs">
    <li class="active"><a href="#"><?php echo Yii::t('app','Month') ?></a></li>
    <li><a href="http://<?php echo ROOT_URL ?>/chart/year"><?php echo Yii::t('app','Year') ?></a></li>
</ul>

<form class="form-inline animate-in" role="form" style='padding: 30px 0;' method='post' id='month' data-anim-type="bounce-in-right-large" data-anim-delay="500">
    ...
    <button class="btn btn-default" name='submitMonth'><?php echo Yii::t('app','Show') ?></button>
</form>
<div id='chartMonth' style='display: none'>
    <?php if(isset($month) && isset($year)): ?>
        <h4 class='text-left text-primary animate-in'  data-anim-type="bounce-in-right-large" data-anim-delay="500"><?php echo Yii::t('app','Month').': '.$month.' - '.Yii::t('app','Year').': '.$year ?></h4>
    <?php endif; ?>
    <div class="panel panel-success animate-in"  data-anim-type="bounce-in-left-large" data-anim-delay="0">
        <div class="panel-heading text-center"><h4><?php echo Yii::t('app','Number of time late, early, overtime per month') ?></h4></div>
    ...
    <div class="panel panel-warning animate-in"  data-anim-type="bounce-in-left-large" data-anim-delay="0">
        <div class="panel-heading text-center"><h4><?php echo Yii::t('app','Hour late, early, overtime per month') ?></h4></div>
        <div class="panel-body">
    ...
    <div class="row show-grid animate-in"  data-anim-type="bounce-in-left-large" data-anim-delay="0">
        ...
        <div class="panel panel-primary ">
            ...
            <div class="panel-body">
                <table class="highchart table" data-graph-container-before="1" data-graph-type="pie"  data-graph-height="250" data-graph-datalabels-enabled="1"'>
                    <thead>
                    <tr>
    ...
    <table class='table' id='chartTable'>
        ...
        <tr>
            ...
            <td>
                <?php if ($statistic[$i]['countLate'] >= 4) {
                        echo "<span class='label label-danger'>".$statistic[$i]['countLate']."</span>";
                } else if ($statistic[$i]['countLate'] < 4 && $statistic[$i]['countLate'] > 1) {
            ...
            <td>
                <?php if ($statistic[$i]['countEarly'] >= 4) {
                    echo "<span class='label label-danger'>".$statistic[$i]['countEarly']."</span>";
                } else if ($statistic[$i]['countLate'] < 4 && $statistic[$i]['countEarly'] > 1) {
