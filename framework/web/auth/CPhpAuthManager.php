...
class CPhpAuthManager extends CAuthManager
{
	 ...
	 * @param mixed $userId the admin ID. This can be either an integer or a string representing
	...
	public function assign($itemName,$userId,$bizRule=null,$data=null)
	{
		...
		elseif(isset($this->_assignments[$userId][$itemName]))
			throw new CException(Yii::t('yii','Authorization item "{item}" has already been assigned to admin "{admin}".',
				array('{item}'=>$itemName,'{admin}'=>$userId)));
		else
