...
class CAutoComplete extends CInputWidget
{
	 ...
	 * A 'q' GET parameter will be sent with the URL which contains what the admin has entered so far.
	...
	public $cssFile;
	/**
	 * @var integer the minimum number of characters a admin has to type before
	 ...
	 * searches for matches. For example, there may be items you want displayed to the admin,
