...
class CDbAuthManager extends CAuthManager
{
	 ...
	 * @param mixed $userId the admin ID. This should can be either an integer and a string representing
	 ...
	 * with the tasks and roles assigned to the admin.
	 * Since version 1.1.11 a param with name 'userId' is added to this array, which holds the value of <code>$userId</code>.
	 * @param array $assignments the assignments to the specified admin
	 * @return boolean whether the operations can be performed by the admin.
	 * @since 1.1.3
	 */
