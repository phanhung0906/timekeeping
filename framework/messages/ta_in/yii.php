...
return array (
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache பயனாளர் சேமிப்பு முடக்கப்பட்டுள்ளது. உங்களின் php.ini கோப்பில் wincache.ucenabled செயலிலுள்ளதா என்று சரிபார்க்கவும்.',
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => 'அனுமதியளிக்கும் "{item}" பொருளில் ஏற்கனவே "{admin}" பயனாளருக்கு அனுமதியளிக்கப்பட்டுள்ளது.',
