...
return array (
  ...
  'Authorization item "{item}" has already been assigned to admin "{admin}".' => '인증 항목 "{item}"는 이미 사용자 "{admin}"에 할당되어있습니다.',
  ...
  'CWinCache admin cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache 사용자 캐시를 사용할 수 없습니다. php.ini의 wincache.ucenabled을 On으로 설정하십시오.',
